...
### AUTO-2026-02-27T20:19:00.322Z (Stage A)
- Decision: **HOLD**
- Reason: Stage A requires at least one pass window with zero mismatch categories before Stage B unlock.
- Failed checks: none
- Stage A zero-mismatch pass in run: **no**
- Window 1: semantic=0.429, mismatches={decision:0, reason:0, missing:2, extra:0}, outputReliability=0.5000, pass=true

### AUTO-2026-02-27T20:22:00.763Z (Stage A)
- Decision: **HOLD**
- Reason: Stage A requires at least one pass window with zero mismatch categories before Stage B unlock.
- Failed checks: none
- Stage A zero-mismatch pass in run: **no**
